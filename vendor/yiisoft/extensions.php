...
return array (
  ...
  array (
    'name' => 'diggindata/yii2-countrylist',
    'version' => 'dev-master',
    'alias' => 
    array (
      '@diggindata/countrylist' => $vendorDir . '/diggindata/yii2-countrylist/src',
    ),
  ),
  'karataserkan/yii2-multi-dataprovider' => 
  array (
    'name' => 'karataserkan/yii2-multi-dataprovider',
    'version' => '1.0.0.0',
    'alias' => 
    array (
      '@karataserkan/yii2MultiDataProvider' => $vendorDir . '/karataserkan/yii2-multi-dataprovider',
    ),
  ),
  ...
  'sjaakp/yii2-helpers' => 
  array (
    'name' => 'sjaakp/yii2-helpers',
    'version' => '1.1.0.0',
    'alias' => 
    array (
      '@sjaakp/helpers' => $vendorDir . '/sjaakp/yii2-helpers',
    ),
  ),
  'sjaakp/yii2-datepager' => 
  array (
    'name' => 'sjaakp/yii2-datepager',
    'version' => '1.1.1.0',
    'alias' => 
    array (
      '@sjaakp/datepager' => $vendorDir . '/sjaakp/yii2-datepager',
    ),
  ),
  'sjaakp/yii2-gcharts' => 
  array (
